...
const plans = [
  {
    ...
    titleColor: "#C0DD97",
    subColor: "#639922",
    features: ["30 點數", "圖片生成 1點/張", "影片生成 6點/支", "角色一致性功能", "批次生成 2張", "角色配音 18點/次", "歷史紀錄保存 30 天 / 5 筆"],
    plan: "starter",
  },
  {
    name: "標準包",
    ...
    titleColor: "#B5D4F4",
    subColor: "#378ADD",
    features: ["80 點數", "圖片生成 1點/張", "影片生成 5點/支", "角色一致性功能", "批次生成 4張", "角色配音 16點/次", "歷史紀錄保存 30 天 / 10 筆", "影片生成費用更優惠"],
    plan: "standard",
  },
  {
    name: "專業包",
    ...
    titleColor: "#FAC775",
    subColor: "#EF9F27",
    features: ["200 點數", "圖片生成 1點/張", "影片生成 4點/支", "角色一致性功能", "批次生成 6張", "角色配音 14點/次", "歷史紀錄保存 90 天 / 30 筆", "影片生成費用最優惠"],
    plan: "pro",
  },
];
// [DNA_PATCH_END]
