...
const lines = [
  {
    ...
    steps: [
      ...
      { icon: "🎙️", label: "加語音／說話影片", cost: "14–18點/次", detail: "10種聲音 TTS 合成（6–8點）+ Kling Avatar 說話影片（8–10點），兩項合計，入門18點・標準16點・專業14點" },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: "🎬", label: "讓角色說話", cost: "14–18點/次", detail: "點「🎬 轉成影片」，角色照片 + 台詞 → TTS 語音合成 + Kling Avatar 說話影片，直接在聊天室播放。入門18點・標準16點・專業14點" },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: "🗣️", label: "說話影片", cost: "14–18點/次", detail: "輸入台詞 → TTS 語音合成（6–8點）+ Kling Avatar 生成說話影片（8–10點），合計入門18點・標準16點・專業14點。需足夠點數，各方案均可使用" },
