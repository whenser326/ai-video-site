...
const lines = [
  {
    ...
    steps: [
      ...
      { icon: "🎬", label: "轉成影片", cost: "4–17點/支", detail: "鎖定角色後生成影片，Kling 3.0（入門6點・標準5點・專業4點）或 Seedance 2.0（入門17點・標準15點・專業13點）" },
      { icon: "🎙️", label: "加語音／說話影片", cost: "14–18點/次", detail: "10種內建聲音或你的克隆聲音 TTS 合成（6–8點）+ Kling Avatar 說話影片（8–10點），兩項合計，入門18點・標準16點・專業14點。聲音克隆付費限定" },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: "💬", label: "開始聊天", cost: "次數制", detail: "免費 100 次・入門 2,000 次・標準 5,000 次・專業 10,000 次，用完後 1點/次。✅ 支援：暖昧挑逗、情感親密 🚫 自動過濾：明確性描述、未成年內容。🔓 聊越多解鎖越多：每聊 50／100／200／500 則，角色會主動說出只有你能看的秘密" },
      { icon: "📸", label: "AI 自拍", cost: "照片 1點・影片 4–6點", detail: "聊天中直接說「拍張照給我」或「錄段影片給我看」，角色立即生成回傳，可指定場景和服裝" },
      { icon: "🎬", label: "讓角色說話", cost: "14–18點/次", detail: "點「🎬 轉成影片」，角色照片 + 台詞 → 用10種內建聲音或你的克隆聲音說話 + Kling Avatar 說話影片，直接在聊天室播放。入門18點・標準16點・專業14點。聲音克隆付費限定" },
    ],
    note: "💡 不知道說什麼？點 💬 讓 AI 幫你想開場白。自建角色群組：免費不開放，入門/標準最多 3 角色，專業最多 5 角色。預設角色群組：所有方案均可用，最多 3 角色（專業 5 角色）。每個角色回覆算一次",
    billing: [
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: "🗣️", label: "說話影片", cost: "14–18點/次", detail: "輸入台詞 → 用10種內建聲音或你的克隆聲音 TTS 合成（6–8點）+ Kling Avatar 生成說話影片（8–10點），合計入門18點・標準16點・專業14點。聲音克隆付費限定，需足夠點數各方案均可使用" },
    ...
    note: "💡 說話影片各方案均可使用（需足夠點數，14–18點/次）。其他影片功能免費用戶每日限 1 支",
    billing: null,
  },
  {
    id: "D",
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 14 }}>
                    {[
                      ...
                      },
                      {
                        ...
                        label: '角色詳細頁',
                        cost: '免費瀏覽',
                        detail: '點任一角色卡片可進入詳細頁，查看完整故事、用戶聊天觸發的自拍作品（照片1點・影片4–6點）、留言區，並直接開始聊天或生成同款',
                        href: null,
                      },
                      {
                        icon: '📤',
                        label: '投稿角色',
                        cost: '免費',
                        detail: '把自己創作的角色投稿給社群，審核通過後上架到探索頁，讓更多人看見你的角色',
                        href: null,
                      },
                    ].map((item, idx, arr) => (
