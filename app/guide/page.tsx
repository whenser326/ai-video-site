...
const lines = [
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: "🎬", label: "步驟2：生成影片", cost: "4-17點/支", detail: "四種功能可選：🎲 AI 自由發揮（AI 自動安排動作，Kling 4-6點）、✍️ 文字指定動作（輸入描述指定動作，Kling 4-6點）、💃 套用動作影片（上傳 MP4 讓角色模仿，Kling 4-6點，付費限定）、🎨 多重參考圖（加入第二角色/場景參考圖，Seedance 13-17點+額外加費，付費限定）。支援 5 秒或 10 秒" },
