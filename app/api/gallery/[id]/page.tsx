  ...
  return (
    <main className="flex h-screen flex-col bg-gradient-to-br from-[#0d2318] via-[#1a3a25] to-[#2d5a3d] overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-white/8 bg-black/20 flex-shrink-0">
        <button onClick={() => router.push('/')} className="text-white/40 hover:text-white/70 transition-all text-sm">←</button>
        <div className="w-10 h-10 rounded-full flex-shrink-0 overflow-hidden bg-white/8 border border-white/10">
          {character.image_url
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white/30 text-[10px]">{character.age}歲・{character.personality_tags.slice(0, 2).join("・")}</p>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] bg-[#89f5a2]/10 border border-[#89f5a2]/20 rounded-full px-2 py-0.5 text-[#89f5a2]/60">官方角色</span>
